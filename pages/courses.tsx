import {Container, Box, Text, Link, Grid, HStack, Icon, Image} from "@chakra-ui/react";
    ...
    >
      ...
      >
        ...
        <Grid gap={4}>
          ...
          <Link isExternal href="https://www.freecodecamp.org/learn/" target="_blank">
            <Box
              _hover={{
                background: "white",
                color: "black",
          ...
          <Link isExternal href="https://fernando-herrera.com/#/courses/Frontend" target="_blank">
            <Box
              _hover={{
                background: "white",
                color: "black",
