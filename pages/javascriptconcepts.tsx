    ...
    >
      ...
      <Box mt={8}>
        ...
        <Text mt={4} mb={4}>
          ...
          tal como un arreglo o cadena, ser expandido en lugares donde cero o
          más argumentos (para llamadas de función) o elementos (para Array
        ...
        <Link
          isExternal
          href="https://es.javascript.info/nullish-coalescing-operator"
        >
        ...
        <Image alt="Objecto" src="img/javascriptconcepts/object.png" w={400} />
        ...
        <Image alt="Array" src="img/javascriptconcepts/array.png" w={400} />
        ...
        <Link
          isExternal
          href="https://es.javascript.info/arrow-functions-basics"
        >
          <Text fontWeight="bold" mt={4} mb={4}>
            Explicación completa en JavaScript Info:{' '}
            <ExternalLinkIcon mx="2px" />
        ...
        <Link
          isExternal
          href="https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Template_literals"
        >
          <Text fontWeight="bold" mt={4} mb={4}>
        ...
        <Link
          isExternal
          href="https://es.javascript.info/destructuring-assignment"
        >
          <Text fontWeight="bold" mt={4} mb={4}>
            Explicación completa en JavaScript Info:{' '}
            <ExternalLinkIcon mx="2px" />
