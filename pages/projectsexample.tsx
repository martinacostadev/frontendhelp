  ...
  return (
    <Page>
      ...
      <Grid gap={4} mt={6} pb={8}>
        ...
        <Text mb={2}>La idea es que experimentes:</Text>
        <Text>
          ✅ Maquetado y ser detallista en esto para que quede prolijo y lindo.
        </Text>
        <Text>✅ Hacer pequeñas y simples animaciones.</Text>
        <Text>
          ✅ Prestar atención al contraste de colores entre los fondos y el
          color de fuente/letra.
        </Text>
        <Text>✅ Interactuar con una API.</Text>
        <Text>✅ Organizar tu proyecto por carpetas y archivos prolijos.</Text>
        <Text>✅ Crear, editar y eliminar registros.</Text>
        <Text>✅ Búsquedas y filtros.</Text>

        <Text mt={4} mb={2}>
          Recomendación: prestale atención a la{' '}
          <Text as="mark">
            UI (User Interface / Interfaz de Usuario) y UX (User Experience /
            Experiencia de Usuario)
          </Text>
          , por lo que{' '}
          <Text as="u">
            es importante que el proyecto sea intuitivo, fácil de usar, de
            entender y demás
          </Text>
          .
        </Text>
        ...
        <Flex flexDirection="column" mb={8}>
          ...
          <Link
            href="https://www.figma.com/community/web_design"
            isExternal
            mb={2}
          >
          ...
          <Link
            href="https://www.behance.net/search/projects?search=paginas%20web&tracking_source=typeahead_search_suggestion"
            isExternal
            mb={2}
          >
